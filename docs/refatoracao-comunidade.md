...
- A Fase 338 extraiu somente `abrirBuscaComunidade` e `fecharBuscaComunidade` a partir dos handlers dos controles da busca; a implementação está no PR desta fase.
