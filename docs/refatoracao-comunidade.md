...
- A Fase 326 extraiu somente `compararUsuariosBuscaComunidade` a partir do comparador inline de `usuariosOrdenados.sort(...)`; a implementação está no PR a ser aberto.
