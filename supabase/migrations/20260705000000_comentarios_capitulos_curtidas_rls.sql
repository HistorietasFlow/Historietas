...
begin
  ...
  -- Remove a constraint antiga para manter somente um índice único.
  alter table public.comentarios_capitulos_curtidas
    drop constraint if exists comentarios_capitulos_curtidas_unique;

  -- Limpeza defensiva antes de aplicar a unicidade.
  ...
  create index if not exists
    comentarios_capitulos_curtidas_comentario_id_idx
    on public.comentarios_capitulos_curtidas (comentario_id);

  create index if not exists
    comentarios_capitulos_curtidas_usuario_id_idx
