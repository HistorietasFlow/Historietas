    ...
    <main style={pageStyle}>
      <section style={isDesktop ? desktopContainerStyle : containerStyle}>
        <header style={isDesktop ? desktopTopStyle : topStyle}>
          ...
          <span style={isDesktop ? desktopEditorLabelStyle : editorLabelStyle}>
            Editor de capítulo
          </span>
        </header>

        <section style={isDesktop ? desktopHeroBoxStyle : heroBoxStyle}>
          <h1 style={isDesktop ? desktopTitleStyle : titleStyle}>Adicionar capítulo</h1>
        ...
        <section style={isDesktop ? desktopMainGridSoloStyle : mainGridStyle}>
          <form onSubmit={criarCapitulo} style={isDesktop ? desktopFormPanelStyle : formPanelStyle}>
            <div style={isDesktop ? desktopFormHeaderStyle : formHeaderStyle}>
              ...
              <h2 style={isDesktop ? desktopFormTitleStyle : formTitleStyle}>Escrever capítulo</h2>
            </div>
...
const logoMarkStyle: CSSProperties = {
  ...
  flex: "0 0 auto",
  boxShadow: "0 12px 28px color-mix(in srgb, var(--historietas-accent, #F97316) 18%, transparent)",
};
...
const editorLabelStyle: CSSProperties = {
  ...
  padding: "0 14px",
  borderRadius: "999px",
  background: "linear-gradient(135deg, color-mix(in srgb, var(--historietas-accent, #F97316) 28%, rgba(255,255,255,0.06)) 0%, color-mix(in srgb, var(--historietas-secondary, #7C3AED) 34%, rgba(255,255,255,0.07)) 100%)",
  border: "1px solid color-mix(in srgb, var(--historietas-accent, #F97316) 32%, rgba(255,255,255,0.12))",
  color: "#FFFFFF",
  fontSize: "11px",
  fontWeight: 950,
  letterSpacing: "0.035em",
  boxShadow: "0 12px 28px rgba(0,0,0,0.22), 0 0 24px color-mix(in srgb, var(--historietas-secondary, #7C3AED) 14%, transparent)",
  textAlign: "center",
  ...safeTextStyle,
};

const desktopEditorLabelStyle: CSSProperties = {
  ...editorLabelStyle,
  minHeight: "40px",
  padding: "0 18px",
  fontSize: "12px",
...
const formPanelStyle: CSSProperties = {
  display: "grid",
  gap: "12px",
  background: "linear-gradient(135deg, color-mix(in srgb, var(--historietas-secondary, #7C3AED) 12%, rgba(18,12,30,0.92)) 0%, rgba(18,12,30,0.96) 100%)",
  border: "1px solid rgba(255,255,255,0.08)",
  borderRadius: "22px",
  padding: "12px",
  boxShadow: "0 14px 38px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.04)",
  minWidth: 0,
  maxWidth: "100%",
  boxSizing: "border-box",
  overflow: "hidden",
...
const primaryButtonStyle: CSSProperties = {
  ...
  fontWeight: 950,
  cursor: "pointer",
  boxShadow: "0 16px 42px color-mix(in srgb, var(--historietas-accent, #F97316) 36%, transparent)",
  fontFamily: "inherit",
  textAlign: "center",
  padding: "0 12px",
  lineHeight: 1.15,
...
const sideSummaryCardStyle: CSSProperties = {
  display: "grid",
  gap: "10px",
  padding: "14px",
  borderRadius: "20px",
  background:
    "linear-gradient(135deg, color-mix(in srgb, var(--historietas-secondary, #7C3AED) 12%, rgba(31,31,35,0.96)) 0%, rgba(18,12,30,0.92) 100%)",
  border: "1px solid rgba(255,255,255,0.08)",
  minWidth: 0,
  maxWidth: "100%",
  boxSizing: "border-box",
...
const sideSummaryTitleStyle: CSSProperties = {
  margin: 0,
  color: "#FFFFFF",
  fontSize: "24px",
  lineHeight: 1.05,
...
const sideSummaryTextStyle: CSSProperties = {
  margin: 0,
  color: "#D4D4D8",
  fontSize: "12px",
  lineHeight: 1.55,
...
const sideSummaryStatsStyle: CSSProperties = {
  display: "flex",
  flexWrap: "wrap",
  gap: "7px",
  minWidth: 0,
...
const desktopHeroBoxStyle: CSSProperties = {
  ...
  alignItems: "center",
  overflow: "hidden",
  boxShadow: "0 16px 42px rgba(0,0,0,0.24), inset 0 1px 0 rgba(255,255,255,0.07)",
};
...
const desktopButtonAreaStyle: CSSProperties = {
  ...buttonAreaStyle,
  gridTemplateColumns: "170px 140px",
